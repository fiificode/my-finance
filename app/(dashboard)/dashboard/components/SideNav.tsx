...
const SideNav = () => {
  ...
  return (
    <aside
      ...
      className={`w-60 sidebar ${isSidebarOpen ? "" : "-translate-x-48"} ${
        isMaximized ? "" : ""
    ...
    >
      ...
      <div
        ...
        } w-full -right-6 transition transform ease-in duration-300 flex items-center justify-between border-4 border-white bg-[#1E293B] absolute top-2 rounded-full h-12`}
      >
      ...
      >
        <Link
          href={"/dashboard"}
          className="hover:ml-4 w-full text-white hover:text-purple-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
